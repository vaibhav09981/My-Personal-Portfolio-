...
const Hero = () => {
  ...
  const fullText = 'Frontend Developer | React Enthusiast | Tech Explorer';
    ...
    <section className="min-h-screen flex flex-col justify-center items-center text-center py-20 px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        <div className="flex justify-center space-x-6 mb-16">
          ...
          <a href="https://github.com/vaibhav09981" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="mailto:vaibhavjj99@gmail.com" className="text-gray-400 hover:text-cyan-400 transition-colors duration-200">
